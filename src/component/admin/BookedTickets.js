...
function BookedTickets(){
    ...
    const getTicketsByMovie = async(movieName) => {
        try{
        const response = await axios.get(`http://localhost:8081/api/v1.0/moviebooking/getAllTicketsByMovie/${movieName}`,{
                        headers:{
    ...
    return(
        <main>
            ...
            <AdminHeader/>
            <h2 classname="headings">Booked Tickets</h2>
